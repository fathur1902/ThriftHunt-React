    ...
    <div className="bg-light d-flex">
      ...
      <div className="sidebar p-4">
        ...
        <button
          ...
          onClick={() => changePage("edit-produk.html")}
        >
        ...
        <button
          ...
          onClick={() => changePage("lihat-pesanan.html")}
        >
            ...
            <div className="card-custom">
              ...
              <div className="mb-3">
                ...
                <textarea
                  ...
                  rows="3"
                >
                  Denim Wrangler 80s dari era 80-an, berbahan denim tebal,
                  berwarna biru dengan sedikit pudar di bagian siku. Tetap
                  nyaman dan pas untuk gaya retro autentik.
                </textarea>
              </div>
              <div className="mb-3">
                ...
                <div>
                  {["S", "M", "L", "XL", "XXL"].map((size) => (
                    <button
                      key={size}
                      className="btn btn-outline-light size-btn"
                    >
                      {size}
                    </button>
                  ))}
              ...
              <div className="mb-3">
                ...
                <div>
                  {["Pria", "Wanita", "Aksesoris"].map((category) => (
                    <button
                      key={category}
                      className="btn btn-outline-light category-btn"
                    >
                      {category}
                    </button>
                  ))}
            ...
            <div className="card-custom">
              <div className="mb-3">
                ...
                <div className="image-upload">
                  {[
                    "Z81jy0cQ4Wp6CJ51eSiTcWleLRix9o9bqKW3PelwrlUguLlnA",
                    "LqeNzARNajVSfUhvnooicrrGVyHGnoRm0hezwleRZjeq7uUeE",
                    "EDHalqGcE26vNF1gEPNWCvJVnKfl0Ts45y7vlAGE1yxq7S5JA",
                    "gQiNQKleeeSfUSekzPBvFeJmG3fqrNOVvONdlS899Azwp7S5JA",
                  ].map((image, index) => (
                    <img
                      key={index}
